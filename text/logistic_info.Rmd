...
Logistic regression also does not involve implicit feature selection. Choosing and scaling what and how many predictor variables to include in the model needs to be done manually. 

Compared to random forest, however, logistical regression models are quick to train and computationally inexpensive, and the final regression coefficients are highly interpretable.
